                ...
                <div class="col-lg-12">
                    <div class="row" id="tabs">
                        ...
                        <div style="text-align:center;" class="col-lg-12">
                            ...
                            <br>
                            <a href="/menu"><input style="color:#fff; background-color:#FB5849; font-size:20px;" class="btn"
                                    type="submit" value="Browse All"></a>
                        </div>
                    </div>
                </div>
            </div>
                                            ...
                                            <div class='info'>
                                                ...
                                                <div class="main-text-button">
                                                    <div class="scroll-to-section">
                                                        <span class="product_rating" style="color: #fac000;">
                                                            @for($i = 1; $i <= $whole; $i++)
                                                        ...
                                                        <br>
                                                        <a href="/rate/{{ $product->id }}" style="color:white;">Rate this</a>
                                                        <p>Quantity: </p>
                                                        @if($product->available == "Stock")
                                                            <form method="post" action="{{route('cart.store', $product->id)}}">
                                                                @csrf
                                                                <input type="number" name="number"
                                                                    style="width: 80px; padding: 8px; border: 1px solid #ccc; border-radius: 8px; font-size: 16px; text-align: center; box-shadow: 0 1px 4px rgba(0,0,0,0.1); transition: all 0.3s ease;"
                                                                    id="myNumber" value="1">
                                                        ...
                                                        @if($product->available != "Stock")
                                                            <form method="post" action="{{route('cart.store', $product->id)}}">
                                                                ...
                                                                <input type="number" name="number"
                                                                    style="width: 80px; padding: 8px; border: 1px solid #ccc; border-radius: 8px; font-size: 16px; text-align: center; box-shadow: 0 1px 4px rgba(0,0,0,0.1); transition: all 0.3s ease;"
                                                                    id="myNumber" value="1">
                                                                <input type="submit" class="btn btn-success" disabled value="Add">
                                                            </form>
                                                        @endif
                                                    </div>
                                                </div>
                        ...
                        <div class="chef-item">
                            <div class="thumb">
                                ...
                                <ul class="social-icons">
                                    <li><a href="{{ $chef->facebook_link  }}" target="_blank"><i class="fa fa-facebook"></i></a>
                                    </li>
                                    <li><a href="{{ $chef->twitter_link  }}" target="_blank"><i class="fa fa-twitter"></i></a>
                                    </li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="message">
                                    ...
                                    <h4>Emails</h4>
                                    <span><a href="mailto:chhetrikushal14@gmail.com">chhetrikushal14@gmail.com</a><br>
                                    </span>
                                </div>
                            </div>
                        </div>
