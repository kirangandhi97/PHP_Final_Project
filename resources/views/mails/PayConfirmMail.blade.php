...
$date = Session::get('date')
  ...
  <div class="row">
    <div class="span8 well invoice-body">
      <table class="table table-bordered" id="customers"
        ...
        <td style="margin-left:20px;">{{ $product->subtotal }} CAD</td>
        </tr>
      @endforeach
        ...
        <td style="margin-left:20px;"></td>
        <td style="margin-left:20px;">{{ $charge->price }} CAD</td>
        </tr>
      @endforeach
          ...
          <tr>
            ...
            <td><strong>{{  $without_discount_price }} CAD</strong></td>
          </tr>
          <tr>
            <td colspan="4"></td>
          </tr>
          <tr>
            ...
            <td><strong>{{  $discount_price }} CAD</strong></td>
          </tr>
          <tr>
            <td colspan="4"></td>
          </tr>
  ...
  <div class="row" style="margin-left:20px;">
    <div class="span3" style="font-size:16px;">
      <strong>Humber Admin</strong>
    </div>
    <br>
    <div class="span3">
      <strong>Phone:</strong>(416)826-0732
    </div>
    <div class="span3">
      <strong>Email:</strong> <a href="chhetrikushal14@gmail.com">chhetrikushal14@gmail.com</a>
    </div>
