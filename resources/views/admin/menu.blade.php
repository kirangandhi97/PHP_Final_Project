...
@section('container')
  ...
  <a href="/add/menu" type="button" class="btn btn-success" style="width:170px;height:35px;padding-top:9px;">+ Add
    Menu</a>
  ...
  @endif
    ...
    <div class="card-body">
      ...
      <p style="text-transform:capitalize;">Catagory : {{ $product->category }}</p>
    ...
    @endif
      <p style="text-transform:capitalize;">Price : {{ $product->price }} CAD</p>
