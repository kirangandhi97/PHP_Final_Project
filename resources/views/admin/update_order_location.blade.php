...
@section('container')
  ...
  <div class="row ">
    ...
    <div class="card">
      ...
      <form class="forms-sample" action="{{ asset('/invoice/approve/' . $product->invoice_no) }}" method="post"
      ...
      <input type="text" style="background-color:black !important;" name="" value="{{ $product->delivery_time }}"
      class="form-control" id="exampleInputName1" readonly>

      </div>

      <div class="form-group">
      <label for="exampleInputName1">Delivery Time (Now)</label>
      <input type="datetime-local" name="time" value="{{ $product->delivery_time }}" class="form-control"
