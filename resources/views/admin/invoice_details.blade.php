...
@section('container')
  ...
  <div class="row ">
    ...
    <div class="card">
      ...
      <input type="datetime-local" name="time" value="" class="form-control" id="exampleInputName1">
      </div>


      <button type="submit" class="btn btn-primary me-2">Approve Order</button>
      <a href="{{  asset('/invoice/cancel-order/' . $product->invoice_no) }}" class="btn btn-danger">Cancel
      Order</a>
      </form>
