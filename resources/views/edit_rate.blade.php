...
@section('page-content')
    ...
    $fraction = $per_rate - $whole
                ...
                <div id="rate" class="rate" style="margin-right:410px; transform: scale(0.9); !important">

                    <label id="star5" onclick="rate(5)" style="color: #fac000;"></label>
                    <label id="star4" onclick="rate(4)" style="color: #fac000;"></label>
                    <label id="star3" onclick="rate(3)" style="color: #fac000;"></label>
                    <label id="star2" onclick="rate(2)" style="color: #fac000;"></label>
                    <label id="star1" onclick="rate(1)" style="color: #fac000; margin-left:-150px; !important"></label>
                </div>
