...
class AdminController extends Controller
{
    ...
    public function add_admin_process(Request $req)
    {
        ...
        $details = [
            'title' => 'Mail from Midway Dine',
            'body' => 'Congrats ! You are selected as a ' . $usertype . ' ( Salary - ' . $req->salary . 'CAD ) of RMS by Midway Dine Panel. Your Email ID - ' . $req->email . ' & Password - ' . $req->password,
        ];
    ...
    public function delete_admin($id)
    {
        ...
        $details = [
            'title' => 'Mail from Midway Dine',
            'body' => 'Sorry ! You have been fired from your job by Midway Dine Panel.So, your account is deleted by Midway Dine Panel.',
        ];
    ...
    public function edit_admin_process(Request $req, $id)
    {
        ...
        if ($update) {
            $details = [
                'title' => 'Mail from Midway Dine',
                'body' => 'Congrats ! Your information is updated by Midway Dine Panel.',
            ];
            ...
            if (($req->salary != NULL && $req->salary > $previous_salary) || ($req->type != NULL && $req->type < $previous_position)) {
                ...
                $details = [
                    'title' => 'Mail from Midway Dine',
                    'body' => 'Congrats ! You are promoted for a ' . $usertype . ' position. ( Now, Your salary - ' . $req->salary . 'CAD ) of RMS by Midway Dine Panel.',
                ];
                ...
                $details = [
                    'title' => 'Mail from Midway Dine',
                    'body' => 'Sorry ! You are depromoted for a ' . $usertype . ' position. ( Now, Your salary - ' . $req->salary . 'CAD ) of RMS by Midway Dine Panel.',
                ];
    ...
    public function add_delivery_boy_process(Request $req)
    {
        ...
        $details = [
            'title' => 'Mail from Midway Dine',
            'body' => 'Congrats ! You are selected as a Delivery Boy position ( Salary - ' . $req->salary . 'CAD ) of RMS by Midway Dine Panel. Your Email ID - ' . $req->email . ' & Password - ' . $req->password,
        ];
    ...
    public function edit_delivery_boy_process(Request $req, $id)
    {
        ...
        if ($update) {
            ...
            if (($req->salary != NULL && $req->salary > $previous_salary)) {
                ...
                $details = [
                    'title' => 'Mail from Midway Dine',
                    'body' => 'Congrats ! You are promoted for a  Delivery Boy position. ( Now, Your salary - ' . $req->salary . 'CAD ) of RMS by Midway Dine Panel.',
                ];
                ...
                $details = [
                    'title' => 'Mail from Midway Dine',
                    'body' => 'Sorry ! You are depromoted for a  Delivery Boy position. ( Now, Your salary - ' . $req->salary . 'CAD ) of RMS by Midway Dine Panel.',
                ];
