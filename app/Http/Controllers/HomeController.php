...
class HomeController extends Controller
{
    ...
    public function redirects()
    {
        ...
        $cart_amount = Auth::user()
            ? DB::table('carts')->where('user_id', Auth::user()->id)->where('product_order', 'no')->count()
            : 0;
        ...
        if ($usertype != '0') {
            ...
            // Top-rated product fetch (optional, could be used later)
            $product_get = [];
