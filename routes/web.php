...
Route::get('/checkout/address', [StripeController::class, 'showAddressForm'])->name('checkout.address');
Route::post('/checkout/address', [StripeController::class, 'submitAddressForm'])->name('checkout.address.submit');
